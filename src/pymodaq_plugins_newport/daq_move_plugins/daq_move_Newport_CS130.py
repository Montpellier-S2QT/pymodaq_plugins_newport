...
class DAQ_Move_Newport_CS130(DAQ_Move_base):
    ...
    This plugins controls Newport/CornerStone C130 monochromator
    It has been tested with an USB CS130 monochromator with Pymodaq 4.1 in a Win10 operating system
